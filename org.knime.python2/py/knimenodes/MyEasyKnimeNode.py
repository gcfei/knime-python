...
class MyEasyPythonNode():
    ...
    operation: str = parameter(str)
    constant: int = parameter(int)

    def configure(self, spec1: dict, spec2: dict) -> dict:
        spec1_type = spec1[self.column1]['type']
        spec2_type = spec2[self.column2]['type']
    ...
    def execute(self, table1: DataFrame, table2: DataFrame) -> DataFrame:
        number1 = table1[self.column1]
        number2 = table1[self.column2]
